...
Read README.md, OFFICE.md, RUNTIME.md and AGENT_TEAM.md before changing architecture. This repository contains only the Virtual Team office. Other repositories on the host are out of scope.
