...
- Sam's workspace opens first. Select another character in the scene or team list to open their **Chat**, **Tasks**, **Review**, and **Profile** panel. The panel docks on wide desktops and overlays the office on tablets. **Escape** closes the selection.
