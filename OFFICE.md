...
This is the office and interaction layer with real cloud persistence and one live coding worker, Sam. Sam's general chat is read-only; assignments authorize isolated code editing. His availability depends on the owner's computer and worker. All 20 agent role definitions and skill assignments are configured in the roster. Seven additional roles execute project documents and independent document reviews; Figma, project frontend and browser QA remain capability-blocked. Desk displays, room occupancy and meeting attendance remain illustrative local animation. No microphone or voice meeting runtime is connected. See RUNTIME.md for worker setup and boundaries.
