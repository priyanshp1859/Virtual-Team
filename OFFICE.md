...
- **Departments & skills** opens a searchable directory of 20 profiles across Leadership, Product, Design, Engineering, QA and Platform. Each profile lists responsibilities, deliverables, boundaries, assigned skills and pinned source links. Department groups in the sidebar expose all 20 chats. New profiles await physical seating and runtime connection; the existing six avatars retain their identities.
...
The **Projects & approvals** view contains kickoff, the ordered handoffs, versioned documents, independent reviews, owner decisions, questions and project conversation/history. It reflects persisted worker activity. See PROJECT_WORKFLOW.md.
